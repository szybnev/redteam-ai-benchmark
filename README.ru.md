...
Оригинальный репозиторий на GitHub больше недоступен, поскольку его владельца забанили на GitHub. Альтернативный репозиторий оригинального автора доступен на [gitlab.com/toxy4ny/redteam-ai-benchmark](https://gitlab.com/toxy4ny/redteam-ai-benchmark). Текущий владелец этого репозитория является активным разработчиком и сопровождающим проекта.
